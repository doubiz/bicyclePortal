...
class BicyclesControllerTest < ActionController::TestCase
  ...
  test "should create bicycle" do
    assert_difference('Bicycle.count') do
      post :create, bicycle: { name: @bicycle.name, photo: @bicycle.photo, price: @bicycle.price, style: @bicycle.style }
    end
  ...
  test "should update bicycle" do
    patch :update, id: @bicycle, bicycle: { name: @bicycle.name, photo: @bicycle.photo, price: @bicycle.price, style: @bicycle.style }
    assert_redirected_to bicycle_path(assigns(:bicycle))
  end
